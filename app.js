//token contract address (BOG)
var tokenAddress="0xb09fe1613fe03e7361319d2a43edc17422f36b09"; 
//BOG-WBNB liqudity pool address from Uniswap
var liquidityAddress="0xdD901faf9652D474b0A70263E13DA294990d49AE";
    ...
    try {
        $.ajax({url: "https://www.binance.com/api/v3/avgPrice?symbol=BNBUSDT", async: false, success: function( data ) {
            ...
            contract.methods.getReserves().call(function(error, result){
                ...
                $('#result').text('$'+tokenPrice.toFixed(8))
